...
9. p-value: F-통계량이 0일 때의 p-value. 작을수록 모델이 데이터에 잘 적합
...
4. 의 Residual standard error항목의 결과는 4.906 on 390 degrees of freedom이다.
	...
	- [[잔차표준오차(RSE)]]가 작을수록 모델이 데이터에 잘 적합되었다고 볼 수 있으며, [[자유도(degree of freedom)]]가 클수록 모델이 더 정확하게 추정될 가능성이 높다. 하지만 자유도가 너무 크면 과적합(overfitting)의 위험이 있다. 
